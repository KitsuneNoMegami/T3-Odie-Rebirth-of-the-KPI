...
**Ce cahier des charges n'est pas rigide. Laissez parler votre créativité et ajustez/ajoutez des choses si l'envi vous viens.**
...
- **Récompenser** le joueur (gain de points) si l’audit est réussi
- **Pénaliser** le joueur (perte de points) si l’audit est échoué

##### Réussir un audit

Un audit est considéré comme réussi si les statistiques du joueur atteignent le niveau requis pour "attaquer" un pôle.  
Plus la **santé** d’un pôle est faible, plus les prérequis sont élevés… mais plus la récompense est importante.

> **Remarque** : La santé d’un pôle n’est pas visible directement. Le joueur devra se fier à son intuition, à des indices fournis dans le jeu, ou tenter sa chance.

##### Échouer un audit

Si les statistiques du joueur sont insuffisantes face aux exigences d’un pôle, l’audit échoue. Le joueur subit alors une ou plusieurs pénalités sur ses points de compétence et/ou de crédibilité.
